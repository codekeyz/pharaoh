...
void main() {
  test('case insensitive static routes of level 1', () {
    ...
    final router = Spanner(config: config)..addRoute(HTTPMethod.GET, '/woo', okHdler);
  ...
  test('case insensitive static routes of level 2', () {
    final config = const RouterConfig(caseSensitive: false);
    final router = Spanner(config: config)..addRoute(HTTPMethod.GET, '/foo/woo', okHdler);
  ...
  test('case insensitive static routes of level 3', () {
    ...
    final router = Spanner(config: config)
      ..addRoute(HTTPMethod.GET, '/foo/bar/woo', okHdler);
  ...
  test('parametric case insensitive', () {
    final config = const RouterConfig(caseSensitive: false);
    final router = Spanner(config: config)
      ..addRoute(HTTPMethod.GET, '/foo/<param>', okHdler);
  ...
  test('case insensitive with capital letter in static path with param', () {
    final config = const RouterConfig(caseSensitive: false);
    final router = Spanner(config: config)
      ..addRoute(HTTPMethod.GET, '/Foo/bar/<param>', okHdler);
  ...
  test(
    ...
    final router = Spanner(config: config)
      ..addRoute(HTTPMethod.GET, '/Foo/bar/<param>', okHdler)
      ..addRoute(HTTPMethod.GET, '/Foo/baz/<param>', okHdler);
  ...
  test('case insensitive with multiple mixed-case params', () {
    final config = const RouterConfig(caseSensitive: false);
    final router = Spanner(config: config)
      ..addRoute(HTTPMethod.GET, '/foo/<param1>/<param2>', okHdler);
  ...
  test('parametric case insensitive with multiple routes', () {
    final config = const RouterConfig(caseSensitive: false);
    final router = Spanner(config: config)
      ..addRoute(HTTPMethod.POST, '/foo/<param>/Static/<userId>/Save', okHdler)
      ..addRoute(HTTPMethod.POST, '/foo/<param>/Static/<userId>/Update', okHdler)
      ..addRoute(HTTPMethod.POST, '/foo/<param>/Static/<userId>/CANCEL', okHdler);
  ...
  test('case insensitive with multiple mixed-case params within same slash couple', () {
    final config = const RouterConfig(caseSensitive: false);
    final router = Spanner(config: config)
      ..addRoute(HTTPMethod.GET, '/users/<userId>', okHdler)
      ..addRoute(HTTPMethod.GET, '/users/user-<userId>.png<roomId>.dmg', okHdler)
      ..addRoute(HTTPMethod.GET, '/foo/<param1>-<param2>', okHdler);
  ...
  test('parametric case insensitive with a static part', () {
    final config = const RouterConfig(caseSensitive: false);
    final router = Spanner(config: config)
      ..addRoute(HTTPMethod.GET, '/foo/my-<param>', okHdler);
